...
export default function HomeScreen() {
  ...
  const displayName =
    data?.user.fullName || user?.fullName || user?.username || "Talaba";
    ...
    <ScreenContainer className="p-4">
      ...
      >
        <View className="gap-6">
          ...
          {isLoading ? (
            ...
            <>
              ...
              >
                ...
                <Text
                  sarlavha
                  className="text-xl font-bold text-background mb-1"
                >
                  Quiz yechish
                </Text>
              ...
              <View className="bg-surface rounded-2xl p-4 border border-border gap-3">
                ...
                <View className="flex-row gap-2">
                  <View className="flex-1 bg-primary/10 rounded-2xl p-3">
          ...
          <View className="bg-surface/50 rounded-2xl p-4 border border-border border-dashed gap-2">
            <Text className="text-sm font-semibold text-muted">
              🚧 Tez kunda
            </Text>
            <Text className="text-xs text-muted">
              3D molekulalar laboratoriyasi, ilmiy adabiyotlar va ommaviy chat
              hozircha faqat saytda mavjud — ilovaga keyingi bosqichda
              qo'shiladi.
            </Text>
          </View>
